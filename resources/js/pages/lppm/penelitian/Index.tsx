                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <div className="relative group w-full sm:w-72">
                            ...
                            <input
                                ...
                                className="bg-slate-50 border border-slate-100 text-sm font-semibold rounded-2xl py-3.5 pl-12 pr-6 w-full focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all placeholder:text-slate-400 shadow-xs"
                            />
                        </div>
                    </div>
                </div>
                ...
                <table className="min-w-full divide-y divide-slate-100">
                    <thead className="bg-slate-50/50">
                        <tr>
                            ...
                            <th className="px-8 py-5 text-left text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Peneliti</th>
                            ...
                            proposals.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="text-sm font-extrabold text-slate-800 line-clamp-2 leading-relaxed mb-2 group-hover:text-blue-700 transition-colors uppercase tracking-tight">{item.judul}</div>
                                        <div className="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black tracking-widest bg-blue-50 text-blue-600 border border-blue-100 uppercase">
                                            {item.skema}
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                            ...
                                            {item.status === 'didanai' && (
                                                <div className="flex items-center gap-2">
                                                    {item.nomor_kontrak ? (
                                                        ...
                                                        <button
                                                            onClick={() => onContractClick(item)}
                                                            className="h-9 px-4 inline-flex items-center rounded-xl bg-blue-600 text-white hover:bg-blue-700 text-xs font-black transition-all shadow-lg shadow-blue-200 uppercase tracking-wider"
                                                        >
                    ...
                    <tbody className="divide-y divide-slate-50">
                        {proposals.length === 0 ? (
                            ...
                            >
                                ...
                                <td className="px-8 py-8 text-center">
                                    <Link href={route('lppm.penelitian.laporan-kemajuan.show', usulan.id)} className="h-9 px-5 inline-flex items-center rounded-xl bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-sm">
                    ...
                    <tbody className="divide-y divide-slate-50">
                        {proposals.length === 0 ? (
                            ...
                            >
                                ...
                                <td className="px-8 py-8 text-center">
                                    <Link href={route('lppm.penelitian.laporan-akhir.show', usulan.id)} className="h-9 px-5 inline-flex items-center rounded-xl bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-sm">
                                        <Eye className="w-3.5 h-3.5 mr-2" /> Detail
                                    </Link>
                                </td>
                            </tr>
                                ...
                                <td className="px-8 py-8">
                                    <div className="space-y-3 min-w-[180px]">
                                        <div className="flex justify-between text-[10px] font-black uppercase tracking-widest text-slate-400">
                                            ...
                                            <span className="text-blue-600 font-black">{item.total_logs || 0}</span>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-tighter">
                                            ...
                                            <span className="text-blue-600 font-black text-xs">{item.last_percentage || 0}%</span>
                                        </div>
                                    </div>
                                </td>
                                <td className="px-8 py-8 text-center text-center">
                                    <Link href={route('lppm.penelitian.catatan-harian.show', item.id)} className="h-9 px-5 inline-flex items-center rounded-xl bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-sm">
