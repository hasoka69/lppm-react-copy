...
import { Home, ChevronRight, Eye, Users } from 'lucide-react';
...
export default function AdminPengabdianIndex({ proposals = [] }: PageProps) {
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            <Head title="Admin LPPM - Daftar Pengabdian" />
            <Header />
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center text-sm text-gray-500 mb-6">
                    ...
                    <span className="font-semibold text-gray-700">Daftar Pengabdian</span>
                </div>
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-800 flex items-center">
                                ...
                                Monitoring Usulan Pengabdian
                            </h1>
                            <p className="text-gray-500 mt-1">
                                Kelola dan pantau seluruh usulan pengabdian masyarakat.
                            </p>
                        </div>
                    </div>
