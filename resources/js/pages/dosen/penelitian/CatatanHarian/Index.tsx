...
export default function Index({ fundedUsulan }: Props) {
    ...
    const filteredList = fundedUsulan.filter(item => item.tahun === selectedYear);
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
                        {[
                            ...
                            { label: 'Catatan Harian', active: true, route: route('dosen.penelitian.catatan-harian.index') },
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-2xl shadow-sm border border-gray-100 shadow-blue-500/5">
                                        ...
                                        filteredList.map((item, index) => (
                                            <tr key={item.id} className="hover:bg-blue-50/20 transition group">
                                                ...
                                                <td className="px-6 py-6 text-center">
                                                    <Link
                                                        href={route('dosen.penelitian.catatan-harian.show', item.id)}
                                                        className="inline-flex items-center justify-center w-10 h-10 border-2 border-blue-100 bg-white text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all shadow-sm group-hover:-translate-y-1 shadow-blue-200/20"
                                        ...
                                        <tr>
                                            <td colSpan={5} className="px-6 py-16 text-center">
                                                <div className="flex flex-col items-center gap-2">
                                                    ...
                                                    <p className="text-sm font-bold text-gray-400 uppercase tracking-widest italic">Tidak ada data penelitian yang didanai.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    )}
