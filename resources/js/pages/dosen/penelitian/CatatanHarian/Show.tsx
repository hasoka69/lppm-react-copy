            ...
            <div className="bg-white border-b border-gray-100 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
                        {[
                            { label: 'Daftar Penelitian', route: isAdminView ? route('lppm.penelitian.index') : route('dosen.penelitian.index') },
                            { label: 'Perbaikan Usulan', route: isAdminView ? route('lppm.penelitian.perbaikan') : route('dosen.penelitian.perbaikan') },
                            ...
                            { label: 'Catatan Harian', active: true, route: isAdminView ? route('lppm.penelitian.catatan-harian') : route('dosen.penelitian.catatan-harian.index') },
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="space-y-1">
                            <Link
                                href={isAdminView ? route('lppm.penelitian.catatan-harian') : route('dosen.penelitian.catatan-harian.index')}
                            ...
                            <p className="text-gray-500 text-[13px] font-medium">Log Aktivitas Penelitian & Perkembangan Program</p>
                        </div>
...
function CatatanModal({ isOpen, onClose, usulanId, log }: { isOpen: boolean, onClose: () => void, usulanId: number, log?: any }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        const url = log
            ? route('dosen.penelitian.catatan-harian.update', log.id)
            : route('dosen.penelitian.catatan-harian.store', usulanId);

        post(url, {
            onSuccess: () => {
                onClose();
                reset();
                toast.success(log ? 'Catatan diperbarui' : 'Catatan ditambahkan');
            },
        });
    };
                        ...
                        <div className="px-8 py-6 bg-gradient-to-r from-gray-900 to-blue-900 flex items-center justify-between shrink-0">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-blue-100/60 text-[10px] font-bold uppercase tracking-widest mt-0.5">Catatan Harian Penelitian</p>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-6 overflow-y-auto custom-scrollbar">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Jelaskan secara detail kemajuan penelitian hari ini..."
