...
const PageUsulan: React.FC<PageUsulanProps> = ({
    ...
    const filteredUsulanList = usulanList.filter(u => {
        // If data is old/legacy (e.g. 2026 only), fuzzy match? 
        // User said "tetep saja di tahun akademik nya maso 2026".
        // But if we want Strict filtering:
        // u.tahun_pelaksanaan should match selectedYear.
        // If u.tahun is 4 digits (e.g. 2026), it might not match 5 digits.
        // Let's coerce: If u.tahun is 4 digits, maybe show it if it matches the Year part?
        // But user explicitly wants "Semester Genap 2025/2026". 
        // Let's check exact match first.
        return u.tahun_pelaksanaan === selectedYear;
    });
                                    ...
                                    <td colSpan={5} style={{ textAlign: "center", padding: "6rem 2rem" }}>
                                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', color: '#94a3b8' }}>
                                            ...
                                            <div style={{ maxWidth: '300px' }}>
                                                ...
                                                <p style={{ marginTop: '0.5rem', fontSize: '0.875rem' }}>Mulai pengabdian atau penelitian Anda dengan mengklik tombol tambah di atas.</p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                            ...
                                            <td className={styles.judulCell} style={{ padding: '1.25rem 0.75rem' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                                                    ...
                                                    <div style={{ display: 'flex', gap: '1rem', marginTop: '0.15rem' }}>
                                                        ...
                                                        <span style={{ fontSize: '0.75rem', color: '#64748b', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                                            <FileText size={12} /> {u.makro_riset}
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
