                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
                        {[
                            ...
                            { label: 'Pengkinian Capaian Luaran', active: true, route: route('dosen.penelitian.pengkinian-luaran.index') }
                        ].map((tab, idx) => (
                            <button
                                key={idx}
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-gray-500 text-[13px] font-medium uppercase tracking-[0.1em] ml-14">Manajemen capaian dan target luaran penelitian</p>
                        </div>
                                        ...
                                        <tr>
                                            <td colSpan={5} className="px-8 py-24 text-center">
                                                <div className="flex flex-col items-center gap-4">
                                                    ...
                                                    <p className="text-gray-400 font-bold tracking-tight">Tidak ada usulan penelitian yang memerlukan pengkinian luaran.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : (
