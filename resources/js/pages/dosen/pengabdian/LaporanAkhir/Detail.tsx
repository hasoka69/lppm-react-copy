...
export default function Detail({ usulan, laporan_akhir, outputs, isAdminView = false }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('dosen.pengabdian.laporan-akhir.update', laporan_akhir.id), {
                                        ...
                                        <div className="p-8 flex-1 flex flex-col items-center justify-center text-center space-y-6">
                                            ...
                                            <div className="space-y-4 w-full">
                                                <div className="text-center">
                                                    <p className="text-[13px] font-bold text-gray-700">Unggah Poster Pengabdian (Opsional)</p>
                                    ...
                                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                                        <div className="p-6 border-b border-gray-50 bg-gray-50/30 flex items-center justify-between">
                                            <h3 className="text-sm font-bold text-gray-700 flex items-center gap-2">
                                                ...
                                                Tautan Video Kegiatan (Opsional)
                                            </h3>
                                        </div>
            ...
            {createPortal(
                isEditing && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        />
                        <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col relative z-10 border border-gray-100">
                            <div className="px-10 py-6 bg-blue-900 flex items-center justify-between">
