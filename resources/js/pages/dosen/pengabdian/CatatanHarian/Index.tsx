            ...
            <div className={styles.tabContainer}>
                ...
                <main className="flex-1 p-6 space-y-6">
                    <div className="flex items-center justify-between">
                        <h1 className="text-xl font-bold text-gray-800">Catatan Harian pengabdian</h1>
                    </div>
                                    ...
                                    {fundedUsulan.length > 0 ? (
                                            ...
                                            <tr key={item.id} className="hover:bg-gray-50/50 transition">
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="space-y-2">
                                                        ...
                                                        <p className="text-[11px] bg-emerald-50 text-emerald-700 px-2 py-1 rounded inline-block font-bold">
                                                ...
                                                <td className="px-6 py-6 text-center">
                                                    <button
                                                        onClick={() => router.visit(route('dosen.pengabdian.catatan-harian.show', item.id))}
                                        ...
                                        <tr>
                                            <td colSpan={6} className="px-6 py-12 text-center text-gray-400">
                                                Tidak ada data pengabdian yang didanai.
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
