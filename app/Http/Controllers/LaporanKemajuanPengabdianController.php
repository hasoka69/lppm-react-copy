...
class LaporanKemajuanPengabdianController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('dosen/pengabdian/LaporanKemajuan/Index', [
    ...
    public function show($usulanId)
    {
        ...
        $report = LaporanKemajuanPengabdian::firstOrCreate(
            ['usulan_id' => $usulan->id],
    ...
    public function update(Request $request, $id)
    {
        ...
        $report = LaporanKemajuanPengabdian::where('user_id', '=', Auth::id(), 'and')->findOrFail($id);
    ...
    public function updateLuaran(Request $request, $luaranId)
    {
        ...
        $report = LaporanKemajuanPengabdian::where('usulan_id', '=', $luaran->usulan_id, 'and')->first();
        ...
        if ($request->hasFile('file_bukti_submit')) {
            ...
            $path = $request->file('file_bukti_submit')->store('bukti_submit_pengabdian', 'public');
    ...
    public function updateSPTB(Request $request, $id)
    {
        ...
        $report = LaporanKemajuanPengabdian::findOrFail($id);
        ...
        if ($request->hasFile('file_sptb')) {
            ...
            $path = $request->file('file_sptb')->store('laporan_kemajuan_pengabdian/sptb', 'public');
    ...
    public function submit($usulanId)
    {
        ...
        return redirect()->route('dosen.pengabdian.laporan-kemajuan.index')
