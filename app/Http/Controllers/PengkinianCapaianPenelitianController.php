...
class PengkinianCapaianPenelitianController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $fundedUsulan = UsulanPenelitian::where('user_id', '=', $user->id, 'and')
            ...
            ->map(fn($u) => [
                ...
                'progress' => $u->luaranList->count() > 0 ? $u->luaranList->map(function ($luaran) {
        ...
        return Inertia::render('dosen/penelitian/PengkinianLuaran/Index', [
